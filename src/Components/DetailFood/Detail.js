...
const Detail = () => {
    ...
    return (
        <div className="detail wrapper" data-aos="zoom-in">
            ...
            <div className="first-about" data-aos="zoom-in">
...
<br />
                ...
                <div className="image-about" data-aos="zoom-in">
...
{/* --------------------------------------------------------- */}
            ...
            <div className="first-about-reverse" data-aos="zoom-in">
                <div className="about-text">
                    <h2>We Deliver</h2>
                    <ul className='points' data-aos="zoom-in">
